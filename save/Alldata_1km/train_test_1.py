...
# %%
# 城市公路工况数据提取 2
city_all_speed = np.load("/home/yuqi.zhao1/Data/speed/city_speed_1.npy")
print(len(city_all_speed))
#档位
city_all_gear = np.load("/home/yuqi.zhao1/Data/gear/city_gear_1.npy").tolist()
...
# 一般公路工况数据提取 1
#速度
suburban_all_speed = np.load("/home/yuqi.zhao1/Data/speed/suburb_speed_1.npy")
print(len(suburban_all_speed))
#档位
suburban_all_gear = np.load("/home/yuqi.zhao1/Data/gear/suburb_gear_1.npy").tolist()
...
# 高速公路工况数据提取 0
#速度
highway_all_speed = np.load("/home/yuqi.zhao1/Data/speed/highway_speed_1.npy")
print(len(highway_all_speed))
#档位
highway_all_gear = np.load("/home/yuqi.zhao1/Data/gear/highway_gear_1.npy").tolist()
...
def check_data(data):
    ...
    # for j in range(len(data_all)):
        ...
        #     (abs(data[4] - data_train[j][4]) < 1e-4):
            ...
            # return
    with open('/home/yuqi.zhao1/paper_program/save/Alldata_1km/DataAll_1.txt','a') as f:
        f.write(str(data))
        f.write('\n')
...
# %%
with open('/home/yuqi.zhao1/paper_program/save/Alldata_1km/DataAll_1.txt','r') as f:
    content = f.readlines()
lines = [line.replace('\n','') for line in content]
...
all_testing_data = []
all_testing_data = random.sample(lines,10709)  # 测试数据为总数据的随机10%
print('test_all:',len(all_testing_data))
all_training_data = []
for i in lines:
    if i not in all_testing_data:
...
np.save('/home/yuqi.zhao1/paper_program/save/Alldata_1km/AllTest_1.npy', all_testing_data) 
all_training_data=np.array(all_training_data,dtype=np.float64)
np.save('/home/yuqi.zhao1/paper_program/save/Alldata_1km/AllTrain_1.npy', all_training_data)
